...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with Tricore Foods & Errands. Reach us by phone, WhatsApp, email or visit our location.",
};
      ...
      <section className="bg-tricore-black pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-tricore-gray-400 text-lg max-w-2xl mx-auto">
            Have a question, need a service or want to partner with us? We are
            here to help.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-tricore-black mb-6">
                Contact Information
              </h2>
              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-tricore-black text-sm mb-0.5">
                      Phone
                    </h3>
              ...
              {/* Social */}
              <div className="mt-8">
                <h3 className="font-semibold text-tricore-black text-sm mb-3">
                  Follow Us
                </h3>
                <div className="flex gap-3">
                  {(["facebook", "instagram", "tiktok", "linkedin"] as const).map(
                    (social) => (
                      <a
                        key={social}
